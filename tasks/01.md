...
- **IMPORTANTE** Leia os arquivos .md que estão dentro de @.github e @docs

## Autenticação

- Rota protegida.
- Apenas o dono do plano de treino pode iniciar uma sessão de treino.
- Caso o WokoutPlan não esteja ativo (isActive=true), o use case deve lançar um erro "WorkoutPlanNotActiveError".
